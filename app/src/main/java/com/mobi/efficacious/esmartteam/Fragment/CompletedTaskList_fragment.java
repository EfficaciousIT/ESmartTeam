...
public class CompletedTaskList_fragment extends Fragment {
    View myview;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ((MainActivity) getActivity()).setActionBarTitle("Completed TaskList");
            ...
            Call<TaskListPojo> call = service.getDailyTaskList("selectCompleted",EMPLOYEEID,ORGID);
