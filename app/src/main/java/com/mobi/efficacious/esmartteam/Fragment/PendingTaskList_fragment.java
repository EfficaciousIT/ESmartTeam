...
public class PendingTaskList_fragment extends Fragment {
    View myview;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ((MainActivity) getActivity()).setActionBarTitle("Pending TaskList");
            ...
            Call<TaskListPojo> call = service.getDailyTaskList("selectPending",EMPLOYEEID,ORGID);
