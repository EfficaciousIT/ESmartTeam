...
import com.mobi.efficacious.esmartteam.activity.SignUp;
...
public class DailyTaskList_fragment extends Fragment{
    View myview;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
      myview=inflater.inflate(R.layout.tasklist_recyclerview, null);
        try {
            ...
            Call<TaskListPojo> call = service.getDailyTaskList("select",EMPLOYEEID,ORGID);
